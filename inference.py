...
parser.add_argument('--img_height', type=int, default=64, help='the height of the input image to network')
parser.add_argument('--img_width', type=int, default=480, help='the width of the input image to network')
parser.add_argument('--hidden_size', type=int, default=1024, help='size of the lstm hidden state')
parser.add_argument('--encoder', type=str, default='', help="path to encoder (to continue training)")
parser.add_argument('--decoder', type=str, default='', help='path to decoder (to continue training)')
parser.add_argument('--max_width', type=int, default=121, help='the width of the feature map out from cnn')
...
def main():
    image = Image.open(cfg.img_path).convert('L')
    ...
    encoder = crnn.Encoder(1, cfg.hidden_size)
