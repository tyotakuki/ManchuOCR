...
parser.add_argument('--num_workers', type=int, default=0, help='number of data loading num_workers')
...
parser.add_argument('--max_width', type=int, default=61, help='the width of the feature map out from cnn')
...
def main():
    ...
    encoder = crnn.Encoder(channel_size=1, hidden_size=cfg.hidden_size)
